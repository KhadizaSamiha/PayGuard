...
import DocumentPreview from "./DocumentPreview"; // Import DocumentPreview component
          ...
          {documents.length > 0 ? (
            documents.map((document) => (
              <TableRow key={document.id}>
                ...
                <TableCell>
                  <button className="bg-blue-400 px-3 py-1.5 rounded-lg text-white me-2">
                    Approve
                  </button>
                  <button className="bg-red-400 px-3 py-1.5 rounded-lg text-white">
                    Reject
                  </button>
                </TableCell>
              </TableRow>
